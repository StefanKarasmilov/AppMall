...
public class NuevoCineFragment extends DialogFragment implements View.OnClickListener {

    private EditText etNombre, etHorario;
    private Button btnSubirFoto, btnPublicar, btnCancelar;
    private ProgressBar progressBar;
    private LinearLayout linearLayout;
    private String nombre, photoUrl = "", horario, fechaPublicacion;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        storage = FirebaseStorage.getInstance().getReference().child("cines");
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.nuevo_cine_full_dialog, container, false);
    ...
    public void onClick(View v) {
        ...
        switch (id){
            ...
            case R.id.buttonNuevaOfertaPublicar:
                if(!nombre.isEmpty() && !photoUrl.equals("") && !horario.isEmpty()){
                    setDataToDatabase();
                    dismiss();
                }else{
                    setErrorText();
    ...
    private void setDataToDatabase(){
        ...
        Cines cine = new Cines(nombre, horario, photoUrl, fechaPublicacion);
        db.collection("cines")
                .document()
                .set(cine)
